...
function _sectionRtt() {
  return `
    <div class="pt-palette-section" id="rtt-section">
      ...
      <div class="pt-palette-row" title="Show ±2 standard deviation residual band around regression line"><span class="pt-palette-label">Band <i class="bi bi-file-bar-graph form-label-sm"></i></span><select class="pt-palette-select" id="rtt-resid-band-show"><option value="off">Off</option><option value="on">On</option></select></div>
