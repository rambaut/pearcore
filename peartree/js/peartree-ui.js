...
function _sectionCladeHighlights() {
  return `
    <div class="pt-palette-section" id="clade-highlights-section">
      ...
      <div class="pt-palette-row"><span class="pt-palette-label">Right edge </span><select class="pt-palette-select" id="clade-highlight-right-edge"><option value="hardTips">At tip</option><option value="hardAlign">At label left</option><option value="hardRight">At label right</option><option value="outlineTips">Outline tips</option></select></div>
