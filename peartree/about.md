...
- **Wellcome Trust** — through the [ARTIC Network](https://artic.network/), a project developing rapid genomic surveillance and outbreak response tools for viral pathogens.

- **Bill & Melinda Gates Foundation** — supporting open-source genomic epidemiology tools for global health.
